        ...
        <main className="min-h-screen bg-gradient-to-br from-banc-dark-deep via-[#1a1d21] to-[#0f1113] pt-24 pb-16">
          <div className="mx-auto max-w-7xl px-4 lg:px-10">
            <div className="flex items-center justify-center h-64">
              <div className="animate-spin h-8 w-8 border-2 border-banc-sky border-t-transparent rounded-full" />
            </div>
          </div>
        </main>
        <Footer />
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {favorites.map((favorite, index) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <Link href={`/sales/properties/${favorite.propertyId}`}>
                      <h3 className="font-semibold text-white group-hover:text-banc-sky transition-colors line-clamp-1">
