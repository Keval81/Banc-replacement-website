        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Button className="bg-[#D4AF37] hover:bg-[#7A5C00] text-white px-8 py-6 text-base">
                Premier Valuation
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="text-center mb-12">
            <p className="text-sm uppercase tracking-[0.3em] text-[#D4AF37]">The Premier Difference</p>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="rounded-2xl border border-[#E0DFDC] p-8 text-center">
              <Crown className="h-12 w-12 text-[#D4AF37] mx-auto" />
            ...
            <div className="rounded-2xl border border-[#E0DFDC] p-8 text-center">
              <Award className="h-12 w-12 text-[#D4AF37] mx-auto" />
            ...
            <div className="rounded-2xl border border-[#E0DFDC] p-8 text-center">
              <TrendingUp className="h-12 w-12 text-[#D4AF37] mx-auto" />
      ...
      <section className="bg-[#F4F3F1] py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-[#D4AF37]">Eligibility</p>
