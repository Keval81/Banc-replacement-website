...
export default function BecomePartnerPage() {
  return (
    <div className="min-h-screen bg-[#F0F0ED]">
      ...
      <section className="relative overflow-hidden bg-[#2C2F33]">
        ...
        <div className="absolute inset-0 opacity-5">
          <div
            ...
            style={{
              backgroundImage: `radial-gradient(circle at 2px 2px, #1DBFDD 1px, transparent 0)`,
        ...
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#1DBFDD]/10 via-transparent to-transparent" />

        <div className="relative mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32">
          <div className="mx-auto max-w-4xl text-center">
            {/* Eyebrow */}
            <p className="mb-6 inline-flex items-center gap-2 rounded-full bg-[#1DBFDD]/10 px-4 py-2 text-sm font-medium uppercase tracking-[0.2em] text-[#1DBFDD]">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <a
                ...
                className="group"
              >
                <Button className="bg-[#1DBFDD] px-8 py-6 text-base font-medium text-white transition-all duration-300 hover:bg-[#0E8CAB] hover:shadow-lg hover:shadow-[#1DBFDD]/25">
                  Apply Now
              ...
              <a href="#opportunity">
                <Button
                  variant="outline"
                  className="border-white/30 bg-transparent px-8 py-6 text-base text-white transition-all duration-300 hover:border-[#1DBFDD] hover:bg-[#1DBFDD]/10 hover:text-white"
                >
                  Learn More
                </Button>
              </a>
        ...
        {/* Decorative Elements */}
        <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#1DBFDD]/50 to-transparent" />
      </section>
      ...
      <section id="opportunity" className="py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            {/* Content */}
            <div>
              <p className="text-sm font-medium uppercase tracking-[0.3em] text-[#1DBFDD]">
                The Opportunity
              </p>
              <h2 className="mt-4 font-heading text-3xl font-semibold text-[#2C2F33] sm:text-4xl lg:text-5xl">
                Run Your Own Business with Professional Support
              </h2>
              <div className="mt-6 space-y-4 text-lg leading-relaxed text-[#6B6E72]">
                <p>
                  We are looking for local business partners in{" "}
                  <strong className="text-[#2C2F33]">North London</strong>,{" "}
                  <strong className="text-[#2C2F33]">Hertfordshire</strong> and{" "}
                  <strong className="text-[#2C2F33]">Essex</strong> areas.
                </p>
                <p>
            ...
            <div className="relative">
              <div className="relative overflow-hidden rounded-2xl bg-[#2C2F33] p-8 shadow-2xl lg:p-10">
                {/* Decorative gradient */}
                <div className="absolute -right-20 -top-20 h-40 w-40 rounded-full bg-[#1DBFDD]/20 blur-3xl" />
                
                <div className="relative">
                  <div className="mb-6 inline-flex h-14 w-14 items-center justify-center rounded-xl bg-[#1DBFDD]/20">
                    <Briefcase className="h-7 w-7 text-[#1DBFDD]" />
                  </div>
                  ...
                  <div className="mt-8 grid grid-cols-2 gap-6 border-t border-white/10 pt-8">
                    <div>
                      <p className="font-heading text-3xl font-bold text-[#1DBFDD]">3</p>
                      <p className="mt-1 text-sm text-white/60">Key Regions</p>
                    </div>
                    <div>
                      <p className="font-heading text-3xl font-bold text-[#1DBFDD]">∞</p>
              ...
              <div className="absolute -bottom-4 -right-4 -z-10 h-full w-full rounded-2xl bg-[#1DBFDD]/20" />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Benefits Section */}
      <section className="bg-[#2C2F33] py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          {/* Section Header */}
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="group rounded-2xl border border-white/10 bg-white/5 p-6 transition-all duration-300 hover:border-[#1DBFDD]/50 hover:bg-white/10"
              >
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[#1DBFDD]/20 transition-colors duration-300 group-hover:bg-[#1DBFDD]">
                  <benefit.icon className="h-6 w-6 text-[#1DBFDD] transition-colors duration-300 group-hover:text-white" />
                </div>
      ...
      <section className="py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <div className="mt-16 grid gap-8 lg:grid-cols-2">
            {/* You Handle */}
            <div className="overflow-hidden rounded-2xl border border-[#2C2F33]/10 bg-white shadow-lg">
              <div className="bg-[#2C2F33] px-6 py-5">
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#1DBFDD]">
                ...
                <ul className="space-y-4">
                  {youHandle.map((item, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <CheckCircle2 className="mt-0.5 h-5 w-5 flex-shrink-0 text-[#1DBFDD]" />
            ...
            {/* We Handle */}
            <div className="overflow-hidden rounded-2xl border border-[#1DBFDD]/20 bg-white shadow-lg shadow-[#1DBFDD]/5">
              <div className="bg-[#1DBFDD] px-6 py-5">
                <div className="flex items-center gap-3">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {partnerTraits.map((trait, index) => (
              ...
              >
                {/* Hover accent */}
                <div className="absolute left-0 top-0 h-full w-1 bg-[#1DBFDD] opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                
                <div className="flex items-start gap-4">
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-[#1DBFDD]/20 transition-colors duration-300 group-hover:bg-[#1DBFDD]">
                    <trait.icon className="h-6 w-6 text-[#1DBFDD] transition-colors duration-300 group-hover:text-white" />
                  </div>
                  <div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <h2 className="mt-4 font-heading text-3xl font-semibold text-[#2C2F33] sm:text-4xl">
              ...
              <div className="mt-8 space-y-4">
                {["North London", "Hertfordshire", "Essex"].map((region) => (
                  <div
                    key={region}
                    className="flex items-center gap-4 rounded-xl border border-[#2C2F33]/10 bg-white p-4 shadow-sm transition-all duration-300 hover:border-[#1DBFDD]/30 hover:shadow-md"
                  >
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#1DBFDD]/10">
                      <Target className="h-5 w-5 text-[#1DBFDD]" />
                    </div>
                    <span className="font-heading text-lg font-medium text-[#2C2F33]">
                      {region}
                    </span>
                  </div>
                ))}
            ...
            <div className="relative">
              <div className="aspect-square overflow-hidden rounded-2xl bg-[#2C2F33] p-8 lg:aspect-auto lg:h-[400px]">
                ...
                <div className="absolute inset-0 opacity-10">
                  ...
                  >
                    <circle cx="200" cy="200" r="150" stroke="#1DBFDD" strokeWidth="1" />
                    <circle cx="200" cy="200" r="100" stroke="#1DBFDD" strokeWidth="1" />
                    <circle cx="200" cy="200" r="50" stroke="#1DBFDD" strokeWidth="2" />
                    <line x1="200" y1="0" x2="200" y2="400" stroke="#1DBFDD" strokeWidth="1" />
                    <line x1="0" y1="200" x2="400" y2="200" stroke="#1DBFDD" strokeWidth="1" />
                  </svg>
                </div>

                <div className="relative flex h-full flex-col items-center justify-center text-center">
                  <div className="mb-6 inline-flex h-20 w-20 items-center justify-center rounded-full bg-[#1DBFDD]/20">
                    <MapPin className="h-10 w-10 text-[#1DBFDD]" />
                  </div>
                  <h3 className="font-heading text-2xl font-semibold text-white">
                    Join Our Network
                  </h3>
      ...
      {/* Contact CTA Section */}
      <section className="relative overflow-hidden bg-[#2C2F33] py-20 lg:py-28">
        {/* Background Elements */}
        <div className="absolute inset-0 opacity-5">
          <div
            className="absolute inset-0"
        ...
        <div className="absolute -left-40 -top-40 h-80 w-80 rounded-full bg-[#1DBFDD]/10 blur-3xl" />
        <div className="absolute -bottom-40 -right-40 h-80 w-80 rounded-full bg-[#1DBFDD]/10 blur-3xl" />

        <div className="relative mx-auto max-w-4xl px-6 text-center lg:px-10">
          <div className="mx-auto mb-6 inline-flex h-16 w-16 items-center justify-center rounded-full bg-[#1DBFDD]/20">
            <Mail className="h-8 w-8 text-[#1DBFDD]" />
          </div>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            >
              <Button className="w-full bg-[#1DBFDD] px-8 py-6 text-base font-medium text-white transition-all duration-300 hover:bg-[#0E8CAB] hover:shadow-lg hover:shadow-[#1DBFDD]/25 sm:w-auto">
            ...
            <a
              ...
              className="w-full sm:w-auto"
            >
              <Button className="w-full bg-white px-8 py-6 text-base font-medium text-[#2C2F33] transition-all duration-300 hover:bg-white/90 sm:w-auto">
                <Mail className="mr-2 h-5 w-5" />
                Email Andrew
              </Button>
            </a>
