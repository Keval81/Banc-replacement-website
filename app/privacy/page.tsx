      ...
      <main className="px-4 py-16 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-12 text-center">
            <h1 className="text-4xl font-semibold text-[#2C2F33] lg:text-5xl">
              Privacy Policy
            </h1>
          ...
          <div className="rounded-2xl bg-white p-8 shadow-lg lg:p-12">
            <div className="prose prose-lg max-w-none text-[#6B6E72]">
              <section className="mb-10">
                <h2 className="text-2xl font-semibold text-[#2C2F33]">1. Introduction</h2>
                <p className="mt-4">
              ...
              <section className="mb-10">
                <h2 className="text-2xl font-semibold text-[#2C2F33]">2. Data Controller</h2>
                <p className="mt-4">
                  Banc Property Group is the data controller responsible for your personal data. Our 
                  registered address is:
                </p>
                <div className="mt-4 rounded-xl bg-[#F0F0ED] p-6">
                  <p className="font-semibold text-[#2C2F33]">Banc Property Group</p>
                  <p className="mt-2">1 Station Road</p>
                  <p>Cuffley, Hertfordshire</p>
                  <p>EN6 4HU</p>
                  <p className="mt-3">
                    Email: <a href="mailto:info@bancproperty.com" className="text-[#1DBFDD] hover:underline">info@bancproperty.com</a>
                  </p>
                  <p>
                    Phone: <a href="tel:01707877781" className="text-[#1DBFDD] hover:underline">01707 877781</a>
                  </p>
                </div>
              </section>

              <section className="mb-10">
                <h2 className="text-2xl font-semibold text-[#2C2F33]">3. What Personal Data We Collect</h2>
                <p className="mt-4">We may collect and process the following personal data:</p>
                
                <h3 className="mt-6 text-xl font-semibold text-[#2C2F33]">3.1 Information You Provide Directly</h3>
                <ul className="mt-3 list-disc space-y-2 pl-6">
                  <li><strong className="text-[#2C2F33]">Contact Information:</strong> Name, email address, phone number, postal address</li>
                  <li><strong className="text-[#2C2F33]">Property Information:</strong> Property address, type, number of bedrooms, and other details relevant to valuations</li>
                  <li><strong className="text-[#2C2F33]">Communication Preferences:</strong> Your preferences for how we contact you</li>
                  <li><strong className="text-[#2C2F33]">Enquiry Details:</strong> Information you provide in contact forms or valuation requests</li>
                </ul>

                <h3 className="mt-6 text-xl font-semibold text-[#2C2F33]">3.2 Information Collected Automatically</h3>
                <ul className="mt-3 list-disc space-y-2 pl-6">
                  <li><strong className="text-[#2C2F33]">Technical Data:</strong> IP address, browser type and version, time zone setting, browser plug-in types, operating system</li>
                  <li><strong className="text-[#2C2F33]">Usage Data:</strong> Information about how you use our website, including pages visited, time spent on pages, and click patterns</li>
                  <li><strong className="text-[#2C2F33]">Cookie Data:</strong> Information stored through cookies (see our Cookie Policy for details)</li>
                </ul>
              </section>

              <section className="mb-10">
                <h2 className="text-2xl font-semibold text-[#2C2F33]">4. How We Collect Your Data</h2>
              ...
              <section className="mb-10">
                <h2 className="text-2xl font-semibold text-[#2C2F33]">5. How We Use Your Data</h2>
                <p className="mt-4">We use your personal data for the following purposes:</p>
                
                <h3 className="mt-6 text-xl font-semibold text-[#2C2F33]">5.1 To Provide Our Services</h3>
                <ul className="mt-3 list-disc space-y-2 pl-6">
                ...
                <h3 className="mt-6 text-xl font-semibold text-[#2C2F33]">5.2 To Communicate With You</h3>
                <ul className="mt-3 list-disc space-y-2 pl-6">
                ...
                <h3 className="mt-6 text-xl font-semibold text-[#2C2F33]">5.3 To Improve Our Services</h3>
                <ul className="mt-3 list-disc space-y-2 pl-6">
                ...
                <h3 className="mt-6 text-xl font-semibold text-[#2C2F33]">5.4 For Legal and Regulatory Purposes</h3>
                <ul className="mt-3 list-disc space-y-2 pl-6">
              ...
              <section className="mb-10">
                <h2 className="text-2xl font-semibold text-[#2C2F33]">6. Legal Basis for Processing</h2>
                <p className="mt-4">We process your personal data based on the following legal grounds:</p>
                <ul className="mt-3 list-disc space-y-2 pl-6">
                  <li><strong className="text-[#2C2F33]">Consent:</strong> Where you have given us explicit consent to process your data for specific purposes</li>
                  <li><strong className="text-[#2C2F33]">Contract:</strong> Where processing is necessary for the performance of a contract with you</li>
                  <li><strong className="text-[#2C2F33]">Legal Obligation:</strong> Where we need to comply with a legal obligation</li>
                  <li><strong className="text-[#2C2F33]">Legitimate Interests:</strong> Where processing is necessary for our legitimate interests or those of a third party, provided your interests do not override these</li>
                </ul>
              </section>

              <section className="mb-10">
                <h2 className="text-2xl font-semibold text-[#2C2F33]">7. Data Sharing and Third Parties</h2>
                <p className="mt-4">We may share your personal data with:</p>
                
                <h3 className="mt-6 text-xl font-semibold text-[#2C2F33]">7.1 Service Providers</h3>
                <p className="mt-3">
                ...
                <h3 className="mt-6 text-xl font-semibold text-[#2C2F33]">7.2 Professional Advisors</h3>
                <p className="mt-3">
                  We may share your data with professional advisors such as solicitors, accountants, and 
                  insurers where necessary.
                </p>

                <h3 className="mt-6 text-xl font-semibold text-[#2C2F33]">7.3 Legal and Regulatory Bodies</h3>
                <p className="mt-3">
                ...
                <h3 className="mt-6 text-xl font-semibold text-[#2C2F33]">7.4 Property Marketing</h3>
                <p className="mt-3">
              ...
              <section className="mb-10">
                <h2 className="text-2xl font-semibold text-[#2C2F33]">8. Data Security</h2>
                <p className="mt-4">
              ...
              <section className="mb-10">
                <h2 className="text-2xl font-semibold text-[#2C2F33]">9. Data Retention</h2>
                <p className="mt-4">
                ...
                <ul className="mt-3 list-disc space-y-2 pl-6">
                  <li><strong className="text-[#2C2F33]">Contact form submissions:</strong> 2 years from last contact</li>
                  <li><strong className="text-[#2C2F33]">Valuation requests:</strong> 3 years from the request date</li>
                  <li><strong className="text-[#2C2F33]">Property transaction records:</strong> 6 years (for legal and tax purposes)</li>
                  <li><strong className="text-[#2C2F33]">Marketing consent records:</strong> Until consent is withdrawn</li>
                </ul>
                <p className="mt-4">
              ...
              <section className="mb-10">
                <h2 className="text-2xl font-semibold text-[#2C2F33]">10. Your Data Protection Rights</h2>
                <p className="mt-4">Under UK GDPR, you have the following rights:</p>
                
                <div className="mt-4 space-y-4">
                  <div className="rounded-lg border border-[#E5E5E5] p-4">
                    <h4 className="font-semibold text-[#2C2F33]">Right to Access</h4>
                    <p className="mt-1 text-sm">You have the right to request copies of your personal data.</p>
                  </div>
                  <div className="rounded-lg border border-[#E5E5E5] p-4">
                    <h4 className="font-semibold text-[#2C2F33]">Right to Rectification</h4>
                  ...
                  <div className="rounded-lg border border-[#E5E5E5] p-4">
                    <h4 className="font-semibold text-[#2C2F33]">Right to Erasure</h4>
                    <p className="mt-1 text-sm">You have the right to request that we erase your personal data, under certain conditions.</p>
                  </div>
                  <div className="rounded-lg border border-[#E5E5E5] p-4">
                    <h4 className="font-semibold text-[#2C2F33]">Right to Restrict Processing</h4>
                  ...
                  <div className="rounded-lg border border-[#E5E5E5] p-4">
                    <h4 className="font-semibold text-[#2C2F33]">Right to Object to Processing</h4>
                    <p className="mt-1 text-sm">You have the right to object to our processing of your personal data, under certain conditions.</p>
                  </div>
                  <div className="rounded-lg border border-[#E5E5E5] p-4">
                    <h4 className="font-semibold text-[#2C2F33]">Right to Data Portability</h4>
                  ...
                  <div className="rounded-lg border border-[#E5E5E5] p-4">
                    <h4 className="font-semibold text-[#2C2F33]">Right to Withdraw Consent</h4>
              ...
              <section className="mb-10">
                <h2 className="text-2xl font-semibold text-[#2C2F33]">11. Cookies and Tracking</h2>
                <p className="mt-4">
                  We use cookies and similar tracking technologies to track activity on our website and 
                  store certain information. For detailed information about the cookies we use and how 
                  to manage your preferences, please see our <a href="/cookies" className="text-[#1DBFDD] hover:underline">Cookie Policy</a>.
                </p>
              </section>

              <section className="mb-10">
                <h2 className="text-2xl font-semibold text-[#2C2F33]">12. Third-Party Links</h2>
                <p className="mt-4">
              ...
              <section className="mb-10">
                <h2 className="text-2xl font-semibold text-[#2C2F33]">13. Changes to This Privacy Policy</h2>
                <p className="mt-4">
              ...
              <section className="mb-10">
                <h2 className="text-2xl font-semibold text-[#2C2F33]">14. Complaints</h2>
                <p className="mt-4">
                ...
                <div className="mt-4 rounded-xl bg-[#F0F0ED] p-6">
                  <p className="font-semibold text-[#2C2F33]">Information Commissioner&apos;s Office</p>
                  <p className="mt-2">Wycliffe House</p>
                  <p>Water Lane</p>
                  <p>Wilmslow</p>
                  <p>Cheshire SK9 5AF</p>
                  <p className="mt-3">
                    Website: <a href="https://ico.org.uk" target="_blank" rel="noopener noreferrer" className="text-[#1DBFDD] hover:underline">ico.org.uk</a>
                  </p>
                </div>
              </section>

              <section>
                <h2 className="text-2xl font-semibold text-[#2C2F33]">15. Contact Us</h2>
                <p className="mt-4">
