  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Sold Prices</h1>
          <p className="text-gray-600">Search HM Land Registry sold price data for any UK postcode</p>
        </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xl font-bold text-gray-900">{formatPrice(stats.averagePrice)}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Median Price</span>
                      <span className="text-lg font-semibold text-gray-900">{formatPrice(stats.medianPrice)}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Sales (12 months)</span>
                      <span className="font-semibold text-gray-900">{stats.salesCount12Months}</span>
                    </div>
                    <div className="flex justify-between items-center">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold text-gray-900">£{stats.pricePerSqft}</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <div className="flex items-center gap-2 ml-auto">
                    <span className="text-sm text-gray-600">{filteredPrices.length} results</span>
                    <div className="flex border rounded-md overflow-hidden">
                      ...
                      <button
                        ...
                        className={`p-2 ${viewMode === 'map' ? 'bg-gray-100' : 'hover:bg-gray-50'}`}
                      >
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="font-semibold text-gray-900">{price.address}</h3>
                          {price.newBuild && (
                            <Badge variant="secondary" className="text-xs">New Build</Badge>
                          )}
                        </div>
                        <p className="text-sm text-gray-500">{price.postcode}</p>
                      ...
                      <div className="text-right">
                        <p className="text-xl font-bold text-gray-900">{price.priceFormatted}</p>
                      </div>
                    </div>
                  </motion.div>
                ))}
        ...
        {!loading && prices.length === 0 && !error && (
          <div className="text-center py-16">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Search for Sold Prices</h3>
            <p className="text-gray-600">Enter a postcode to see sold price history and area statistics</p>
          </div>
        )}
      </div>
    </div>
