    ...
    <div className="bg-white rounded-xl border border-[#C8C9CB] overflow-hidden">
      <div className="px-5 py-4 border-b border-[#C8C9CB]">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-xs text-[#6B6E72]">
            <span className="flex items-center gap-1">
              <span className="w-2 h-2 bg-[#1DBFDD] rounded-full" />
              Available
            </span>
            <span className="flex items-center gap-1">
              <span className="w-2 h-2 bg-[#C8C9CB] rounded-full" />
              Booked
            </span>
          </div>
        </div>
      ...
      <div className="p-5">
        {slots.length === 0 ? (
          <div className="text-center py-6">
            <Clock className="w-10 h-10 text-[#C8C9CB] mx-auto mb-3" />
            <p className="text-[#6B6E72]">No time slots available</p>
          ...
          <div className="text-center py-6">
            <AlertCircle className="w-10 h-10 text-[#C8C9CB] mx-auto mb-3" />
            <p className="text-[#6B6E72]">All slots booked for this date</p>
            <p className="text-sm text-[#6B6E72] mt-1">
              Please select a different date
            </p>
          </div>
                  ...
                  className={`
                    ...
                    ${
                      isSelected
                        ...
                        : isAvailable
                        ? "border-[#C8C9CB] hover:border-[#1DBFDD] hover:bg-[#F0F0ED]"
                        : "border-[#F0F0ED] bg-[#F0F0ED] opacity-50 cursor-not-allowed"
                    }
                  `}
                >
                  <span
                  ...
                  <span className="block text-xs text-[#6B6E72] mt-0.5">
                    {slot.duration} mins
                  </span>
                  {isSelected && (
                    <span className="absolute top-1 right-1">
                      <Check className="w-4 h-4 text-[#1DBFDD]" />
                    </span>
                  )}
                  {!isAvailable && (
                    <span className="absolute inset-0 flex items-center justify-center">
                      <span className="text-xs font-medium text-[#6B6E72] bg-white/80 px-2 py-0.5 rounded">
                        Booked
                      </span>
                    </span>
                  )}
      ...
      {unavailableCount > 0 && availableSlots.length > 0 && (
        <div className="px-5 py-3 border-t border-[#C8C9CB] bg-[#F0F0ED]/50">
          <p className="text-xs text-[#6B6E72] text-center">
