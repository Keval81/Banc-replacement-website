...
export const OrganizationStructuredData = () => {
  const data = {
    ...
    description: "Award-winning estate agents in Cuffley, Mayfair and Hertfordshire. Premium property sales, lettings, and valuations.",
    address: {
      "@type": "PostalAddress",
      streetAddress: "114 Mayfair",
    ...
    sameAs: [
      "https://www.facebook.com/bancproperty",
      "https://www.twitter.com/bancproperty",
      "https://www.linkedin.com/company/banc-property-group",
