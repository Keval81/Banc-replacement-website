          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg border border-white/10 bg-white/5 px-8 py-2 text-sm text-white placeholder:text-white/30 focus:border-banc-sky focus:outline-none"
              />
            </div>
          </div>
      ...
      <div className="rounded-2xl border border-white/10 bg-banc-dark-deep p-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onBlur={() => formatCurrencyDisplay(income1, setIncome1)}
                placeholder="e.g. £50,000"
                className="w-full rounded-xl border border-white/10 bg-white/5 px-10 py-3 text-lg text-white placeholder:text-white/30 focus:border-banc-sky focus:outline-none"
              />
            </div>
          </div>
        ...
        <div className="mt-6">
          <label className="mb-2 block text-sm text-white/70">
            Income Multiplier:
            <span className="ml-2 text-banc-sky">{multiplier}x</span>
          </label>
          <input
            type="range"
            min="3"
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {rateEstimates.map((estimate) => (
                ...
                >
                  ...
                  <p className="my-1 text-xl font-bold text-banc-sky">
          ...
          <div className="rounded-2xl border border-white/10 bg-banc-dark-deep p-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl bg-white/5 p-4">
                ...
                <p className="mt-2 text-sm text-banc-sky">
