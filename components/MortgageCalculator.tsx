        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              value={depositPercent}
              onChange={(e) => handleDepositPercentChange(Number(e.target.value))}
              className="mt-3 h-2 w-full cursor-pointer appearance-none rounded-lg bg-white/10 accent-[#1DBFDD]"
            />
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-lg text-white focus:border-[#1DBFDD] focus:outline-none"
              />
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full appearance-none rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-lg text-white focus:border-[#1DBFDD] focus:outline-none"
              >
                {Array.from({ length: 31 }, (_, i) => i + 10).map((year) => (
                  <option key={year} value={year} className="bg-[#2C2F33]">
                    {year} years
                  </option>
                ))}
              </select>
            ...
            {[
              ...
              >
                <p
                  className={cn(
                    "font-medium",
                    repaymentType === type.value ? "text-[#1DBFDD]" : "text-white"
                  )}
                >
                  {type.label}
                </p>
        ...
        <>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-2xl border border-white/10 bg-[#2C2F33] p-5 text-center">
              ...
              <p className="my-1 text-2xl font-bold text-[#1DBFDD]">
                {formatCurrency(result.monthlyPayment)}
              </p>
              ...
              <div className="flex-1 space-y-4">
                <div className="flex items-center justify-between rounded-xl bg-white/5 p-4">
                  <div className="flex items-center gap-3">
                    <div className="h-4 w-4 rounded-full bg-[#1DBFDD]" />
                  ...
                  <tbody>
                    {yearlySchedule.map((year) => (
                      <tr key={year.year} className="border-b border-white/5">
                        ...
                        <td className="py-2 text-right text-sm text-[#1DBFDD]">
